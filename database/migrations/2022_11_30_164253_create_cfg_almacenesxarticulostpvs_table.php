...
class CreateCfgAlmacenesxarticulostpvsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_almacenesxarticulostpvs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cfg_almacenesxarticulostpvs');
    }
}
