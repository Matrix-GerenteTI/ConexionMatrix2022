...
class CreateCfgArticulosTpvremTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_articulos_tpvrem', function (Blueprint $table) {
            $table->double('ID');
    ...
    {
        Schema::dropIfExists('cfg_articulos_tpvrem');
    }
}
