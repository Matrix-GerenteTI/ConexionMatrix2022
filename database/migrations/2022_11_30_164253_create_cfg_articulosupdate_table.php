...
class CreateCfgArticulosupdateTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_articulosupdate', function (Blueprint $table) {
            $table->double('ID');
    ...
    {
        Schema::dropIfExists('cfg_articulosupdate');
    }
}
