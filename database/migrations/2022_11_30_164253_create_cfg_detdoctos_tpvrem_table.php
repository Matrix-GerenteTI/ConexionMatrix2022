...
class CreateCfgDetdoctosTpvremTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_detdoctos_tpvrem', function (Blueprint $table) {
            $table->double('ID');
    ...
    {
        Schema::dropIfExists('cfg_detdoctos_tpvrem');
    }
}
