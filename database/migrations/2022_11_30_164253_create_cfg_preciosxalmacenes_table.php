...
class CreateCfgPreciosxalmacenesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_preciosxalmacenes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cfg_preciosxalmacenes');
    }
}
