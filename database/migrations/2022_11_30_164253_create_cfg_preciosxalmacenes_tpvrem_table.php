...
class CreateCfgPreciosxalmacenesTpvremTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_preciosxalmacenes_tpvrem', function (Blueprint $table) {
            $table->double('ID');
            ...
            $table->string('PVP1ACTMANUALMENTE')->nullable()->default('');
        });
    }
    ...
    {
        Schema::dropIfExists('cfg_preciosxalmacenes_tpvrem');
    }
}
