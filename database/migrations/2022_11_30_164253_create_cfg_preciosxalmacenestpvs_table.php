...
class CreateCfgPreciosxalmacenestpvsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_preciosxalmacenestpvs', function (Blueprint $table) {
            $table->double('ID');
    ...
    {
        Schema::dropIfExists('cfg_preciosxalmacenestpvs');
    }
}
