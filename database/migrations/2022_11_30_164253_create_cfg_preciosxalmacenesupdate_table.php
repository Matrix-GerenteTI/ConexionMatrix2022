...
class CreateCfgPreciosxalmacenesupdateTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_preciosxalmacenesupdate', function (Blueprint $table) {
            $table->double('ID');
    ...
    {
        Schema::dropIfExists('cfg_preciosxalmacenesupdate');
    }
}
