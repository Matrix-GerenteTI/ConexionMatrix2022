...
class CreateCfgPrexalmxfamxctecrTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cfg_prexalmxfamxctecr', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cfg_prexalmxfamxctecr');
    }
}
