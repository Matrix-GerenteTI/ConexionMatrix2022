...
class CreateCxcRecibosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cxc_recibos', function (Blueprint $table) {
            ...
            $table->double('IMP_FACTU_HISTORCP')->nullable();
            $table->double('IMP_COBRO_HISTORCP')->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('cxc_recibos');
    }
}
