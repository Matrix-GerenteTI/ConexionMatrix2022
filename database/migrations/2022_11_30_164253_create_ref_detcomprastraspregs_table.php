...
class CreateRefDetcomprastraspregsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ref_detcomprastraspregs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ref_detcomprastraspregs');
    }
}
