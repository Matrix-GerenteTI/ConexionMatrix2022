...
class CreateRefDetpedidospresupTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ref_detpedidospresup', function (Blueprint $table) {
            ...
            $table->string('SINEXISTENCIA')->nullable()->default('');
            $table->double('CANTSINEXISTENCIA')->nullable()->default(0);
            ...
            $table->double('FK1MCFG_USUARIOS')->nullable()->default(-1);
            $table->string('DESCUSUARIO')->nullable()->default('');
    ...
    {
        Schema::dropIfExists('ref_detpedidospresup');
    }
}
